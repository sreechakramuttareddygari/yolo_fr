...
get_file https://drive.google.com/uc?id=1qOv-DUZ5VCj81z58CJ_jwQUTA0d4Lx3A CrowdHuman_train01.zip
...
for f in CrowdHuman_train01.zip; do# CrowdHuman_train02.zip CrowdHuman_train03.zip CrowdHuman_val.zip ; do
  unzip -n ${f}
done
